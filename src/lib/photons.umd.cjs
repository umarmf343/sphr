(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Photons = global.Photons || {}, global.THREE));
    ...
    class ParticleState {
        ...
        init() {
            ...
            this.lifetime = 1.0;
            this.age = 0.0;
            this.sequenceElement = new THREE__namespace.Vector4();
            this.position = new THREE__namespace.Vector3();
            this.velocity = new THREE__namespace.Vector3();
            this.acceleration = new THREE__namespace.Vector3();
            this.normal = new THREE__namespace.Vector3();
            this.rotation = 0.0;
            this.rotationalSpeed = 0.0;
            this.size = new THREE__namespace.Vector2();
            this.color = new THREE__namespace.Color();
            this.alpha = 1.0;
            this.initialSize = new THREE__namespace.Vector2();
            this.initialColor = new THREE__namespace.Color();
    ...
    class ParticleStateArray {
        ...
        computeBoundingBox = function() {
            ...
            const tempPos = new THREE__namespace.Vector3();

            return function(outBox = new THREE__namespace.Box3(), positionTransform = null) {
        ...
        computeBoundingSphere = function() {
            ...
            return function(outSphere = new THREE__namespace.Sphere(), positionTransform = null) {
                let radius = 0;
                for (let i = 0; i < this.activeParticleCount; i++) {
                    const particleState = this.getState(i);
                    let pos = particleState.position;
    ...
    class BaseParticleStateOperator extends ParticleStateOperator {
        ...
        constructor() {
            super();
            this.timeScaledVelocity = new THREE__namespace.Vector3();
            this.timeScaledAcceleration = new THREE__namespace.Vector3();
            this.stateAcceleration = new THREE__namespace.Vector3();
            this.stateVelocity = new THREE__namespace.Vector3();
        }
    ...
    class ParticleSystem {
        ...
        static fromJSON(json, jsonTypeStore, threeRenderer) {
            ...
            const rootObject = new THREE__namespace.Object3D();
    ...
    class ParticleStateAttributeArray extends ParticleStateArray {
        ...
        allocate(particleCount) {
            ...
            const createAttributeBuffer = (bufferArray, componentCount) => {
                if (this.instanced) {
                    return new THREE__namespace.InstancedBufferAttribute(bufferArray, componentCount);
                } else {
                    return new THREE__namespace.BufferAttribute(bufferArray, componentCount);
                }
            };
            ...
            if (this.instanced) {
                ...
                this.basePositions = new THREE__namespace.BufferAttribute(basePositionsArray, 3);
                ...
                this.baseUVs = new THREE__namespace.BufferAttribute(baseUVsArray, 2);
                ...
                this.customIndexes = new THREE__namespace.BufferAttribute(customIndexesArray, 1);
                ...
                this.geometry = new THREE__namespace.InstancedBufferGeometry().copy(baseGeometry);
                this.geometry.instanceCount = 0;
            } else {
    ...
    class AnimatedSpriteRenderer extends Renderer {
        ...
        constructor(instanced, atlas, interpolateAtlasFrames = false,
                    blending = THREE__namespace.NormalBlending, calculateBoundingSphereFromBox = true, renderOrder) {
            super();
            this.instanced = instanced;
        ...
        updateMeshBounds = function() {
            ...
            return function() {
                ...
                if (this.calculateBoundingSphereFromBox) {
                    if (!geometry.boundingBox) geometry.boundingBox = new THREE__namespace.Box3();
                    geometry.boundingBox.copy(this.boundingBox);
                    if (!geometry.boundingSphere) {
                        geometry.boundingSphere = new THREE__namespace.Sphere();
                    }
                    ...
                    if (!geometry.boundingSphere) geometry.boundingSphere = new THREE__namespace.Sphere();
        ...
        init(particleCount) {
            if (super.init(particleCount)) {
                ...
                this.mesh = new THREE__namespace.Mesh(this.particleStateArray.getGeometry(), this.material);
        ...
        createMaterial(vertexShader, fragmentShader, customUniforms, useWebGL2, useLogarithmicDepth) {
            ...
            let shaderAtlas = [...Array(16).keys()].map(i => new THREE__namespace.Vector4());
            if (this.atlas) {
                for (let i = 0; i < this.atlas.getFrameSetCount(); i++) {
                    const frameSet = this.atlas.getFrameSet(i);
                    shaderAtlas[i] = new THREE__namespace.Vector4(frameSet.x, frameSet.y, frameSet.width, frameSet.height);
                }
            }
        ...
        static fromJSON(params) {
            ...
            const atlasTexture = new THREE__namespace.TextureLoader().load(atlasJSON.texturePath);
            ...
            if (params.blending == 'Additive') {
                renderer.blending = THREE__namespace.AdditiveBlending;
            } else {
                renderer.blending = THREE__namespace.NormalBlending;
            }
            return renderer;
        }
        ...
        toJSON(texturePathGenerator) {
            ...
            let blending = 'Normal';
            if (this.material.blending === THREE__namespace.AdditiveBlending) {
                blending = 'Additive';
            }
    ...
    class BuiltinType {
        ...
        static getTypeID(type) {
            ...
            if (type === THREE__namespace.Vector2) {
                typeID = BuiltinType.Vector2;
            } else if (type === THREE__namespace.Vector3) {
                typeID = BuiltinType.Vector3;
            } else if (type === THREE__namespace.Vector4) {
                typeID = BuiltinType.Vector4;
            } else if (type === THREE__namespace.Color) {
        ...
        static loadJSONParameter(param, type) {
            switch (type) {
                case THREE__namespace.Vector2:
                    return new THREE__namespace.Vector2().fromArray(param);
                case THREE__namespace.Vector3:
                    return new THREE__namespace.Vector3().fromArray(param);
                case THREE__namespace.Vector4:
                    return new THREE__namespace.Vector4().fromArray(param);
                case THREE__namespace.Color:
                    return new THREE__namespace.Color().fromArray(param);
            }
    ...
    class RandomGenerator extends Generator {
        ...
        static getParameterJSON(param) {
            if (param instanceof THREE__namespace.Vector2 || param instanceof THREE__namespace.Vector3 ||
                param instanceof THREE__namespace.Vector4 || param instanceof THREE__namespace.Color) return param.toArray();
            return param;
        }
    ...
    class BoxPositionInitializer extends ParticleStateInitializer {
        ...
        constructor(range, offset) {
            super();
            this.randomGenerator = new RandomGenerator(THREE__namespace.Vector3, range, offset, 0.0, 0.0, false);
        }
        ...
        static fromJSON(particleSystem, params) {
            return new BoxPositionInitializer(new THREE__namespace.Vector3().fromArray(params.range),
                                              new THREE__namespace.Vector3().fromArray(params.offset));
        }
    ...
    class RandomVelocityInitializer extends ParticleStateInitializer {
        ...
        constructor(directionRange, directionOffset, speedRange, speedOffset, normalizeDirection = true) {
            super();
            this.directionGenerator = new RandomGenerator(THREE__namespace.Vector3, directionRange, directionOffset, 0.0, 0.0, true);
        ...
        static fromJSON(particleSystem, params) {
            return new RandomVelocityInitializer(new THREE__namespace.Vector3().fromArray(params.range),
                                                 new THREE__namespace.Vector3().fromArray(params.offset),
    ...
    class ContinuousArray {
        ...
        * [Symbol.iterator]() {
        ...
        getInterpolatorForTypeID = function() {
            ...
            const upper2 = new THREE__namespace.Vector2();
            const upper3 = new THREE__namespace.Vector3();
            const upper4 = new THREE__namespace.Vector4();
            const upperC = new THREE__namespace.Color();
    ...
    class SizeInterpolatorOperator extends InterpolatorOperator {
        ...
        constructor(relativeToInitialValue = false) {
            super(THREE__namespace.Vector2, relativeToInitialValue);
        }

        addElementsFromParameters(elementParametersTValuePairs) {
            super.addElementsFromElementClassAndParameters(THREE__namespace.Vector2, elementParametersTValuePairs);
        }

        updateState = function() {

            const tempSize = new THREE__namespace.Vector2();
    ...
    class ColorInterpolatorOperator extends InterpolatorOperator {
        ...
        constructor(relativeToInitialValue = false) {
            super(THREE__namespace.Color, relativeToInitialValue);
        }

        addElementsFromParameters(elementParametersTValuePairs) {
            super.addElementsFromElementClassAndParameters(THREE__namespace.Color, elementParametersTValuePairs);
        }

        updateState = function() {

            const tempColor = new THREE__namespace.Color();
    ...
    class SphereRandomGenerator extends Generator {
        ...
        constructor(rangeTheta, offsetTheta, rangePhi, offsetPhi, rangeRadius, offsetRadius,
            ...
            super(THREE__namespace.Vector3);
            ...
            this.tempUp = new THREE__namespace.Vector3().set(0.0, 1.0, 0.0);
        }
    ...
    class FlickerLight extends Component {
        ...
        constructor(parent, intensity, intensityFlux, color, distance, decay, shadows = undefined) {
            ...
            this.lastPositionAdjuster = new THREE__namespace.Vector3();
            this.positionAdjuster = new THREE__namespace.Vector3();
            this.intensity = 1.0;
        ...
        init(parent, intensity, intensityFlux, color, distance, decay, shadows = undefined) {
            this.owner = new THREE__namespace.Object3D();
            parent.add(this.owner);

            color = color || new THREE__namespace.Color();
            distance = distance || 0;
            if (decay == null || decay == undefined) decay = 2.0;
            const shadowsEnabled = !!shadows;

            this.light = new THREE__namespace.PointLight(0xffffff, 2, 0, 1);
    ...
    exports.AccelerationOperator = AccelerationOperator;
    exports.AnimatedSpriteRenderer = AnimatedSpriteRenderer;
    exports.Atlas = Atlas;
    exports.BaseParticleStateInitializer = BaseParticleStateInitializer;
    exports.BaseParticleStateOperator = BaseParticleStateOperator;
    exports.BoxPositionInitializer = BoxPositionInitializer;
    exports.ColorInterpolatorOperator = ColorInterpolatorOperator;
    exports.ConstantParticleEmitter = ConstantParticleEmitter;
    exports.FlickerLight = FlickerLight;
    exports.JSONTypeStore = JSONTypeStore;
    exports.LifetimeInitializer = LifetimeInitializer;
    exports.Manager = Manager;
    exports.OpacityInterpolatorOperator = OpacityInterpolatorOperator;
    exports.ParticleStateArray = ParticleStateArray;
    exports.ParticleSystem = ParticleSystem;
    exports.ParticleSystemState = ParticleSystemState;
    exports.RandomGenerator = RandomGenerator;
    exports.RandomVelocityInitializer = RandomVelocityInitializer;
    exports.Renderer = Renderer;
    exports.RotationInitializer = RotationInitializer;
    exports.RotationalSpeedInitializer = RotationalSpeedInitializer;
    exports.SequenceInitializer = SequenceInitializer;
    exports.SequenceOperator = SequenceOperator;
    exports.SizeInitializer = SizeInitializer;
    exports.SizeInterpolatorOperator = SizeInterpolatorOperator;
    exports.SphereRandomGenerator = SphereRandomGenerator;

}));
//# sourceMappingURL=photons.umd.cjs.map
